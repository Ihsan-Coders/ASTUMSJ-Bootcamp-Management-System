...
export const assignMentor = (data) =>
  axiosInstance.post("/batches/assign-mentor", data);
export const enrollStudent = (data) =>
  axiosInstance.post("/batches/enroll-student", data);
export const assignMentorToStudent = (data) =>
  axiosInstance.post("/batches/assign-mentor-to-student", data);
